# Contributing to aspnet-identity-azure-storageaccount

First and foremost, thank you! We appreciate that you want to contribute to aspnet-identity-azure-storageaccount, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for aspnet-identity-azure-storageaccount**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for aspnet-identity-azure-storageaccount:

- star the [project](https://github.com/joncloud/aspnet-identity-azure-storageaccount)
- tweet your support for aspnet-identity-azure-storageaccount
...
- **version**: (required) please note the version of aspnet-identity-azure-storageaccount are you using
...
The original poster or the maintainers of aspnet-identity-azure-storageaccount may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/aspnet-identity-azure-storageaccount
